...
export const MOCK_REGISTRATIONS = [
  ...
  { id: "r7",  tournament_id: "ff-cs-bermuda", username: "GhostRider_M",   game_uid: "FF-91004",   email: "ghost@example.com",   fee_paid: 200, registered_at: new Date(Date.now() - 3 * 3600000).toISOString(),  payment_status: "confirmed" },
  { id: "r8",  tournament_id: "ff-cs-bermuda", username: "ThunderBolt_S",  game_uid: "FF-77321",   email: "thunder@example.com", fee_paid: 200, registered_at: new Date(Date.now() - 2 * 3600000).toISOString(),  payment_status: "confirmed" },
  { id: "r9",  tournament_id: "ff-cs-bermuda", username: "NeonAssassin",   game_uid: "FF-48871",   email: "neon@example.com",    fee_paid: 500, registered_at: new Date(Date.now() - 80 * 60000).toISOString(),   payment_status: "confirmed" },
  { id: "r10", tournament_id: "ff-cs-bermuda", username: "RedViper_99",    game_uid: "FF-30012",   email: "red@example.com",     fee_paid: 500, registered_at: new Date(Date.now() - 45 * 60000).toISOString(),   payment_status: "confirmed" },

  { id: "r11", tournament_id: "ff-cs-kalahari", username: "NightShade_X",  game_uid: "FF-88241",   email: "night@example.com",   fee_paid: 1000, registered_at: new Date(Date.now() - 2 * 3600000).toISOString(), payment_status: "confirmed" },
  { id: "r12", tournament_id: "ff-cs-kalahari", username: "CyberHawk_V2",  game_uid: "FF-10023",   email: "cyber@example.com",   fee_paid: 1000, registered_at: new Date(Date.now() - 1 * 3600000).toISOString(), payment_status: "confirmed" },
];
